...
// //console.log(omit(userDetails, ['age']));
...
// //console.log(mapKeys(data, (key) => key.toUpperCase()));
// //output: { FIRSTNAME: 'Hannah', LASTNAME: 'Jackson' }

// //----test mapValues------//
// let info = { name: 'Isaac', age: 55 };
// //console.log(mapValues(info, (value) => `${value}-info`));
// //output: { name: 'Isaac-info', age: '55-info' }

// //----test get------//
// let deepData = { user: { profile: { name: 'Jack' } } };
// //console.log(get(deepData, 'user.profile.name'));
// //output: 'Jack'

// // Test with a non-existent path
// //console.log(get(deepData, 'user.profile.age', 'Not Found'));
// //output: 'Not Found'


// //----test has------//
// let obj = { a: { b: { c: 3 } } };
// //console.log(has(obj, 'a.b.c'));  //output: true
// //console.log(has(obj, 'a.b.d'));  //output: false
// //console.log(has(obj, 'a.x.c'));  //output: false

// //----test findKey------//
// let obj0 = { a: 1, b: 2, c: 3 };
// //console.log(findKey(obj0, (key, value) => value > 2));  //output: 'c'
...
// //console.log(deepEqual(objb, objc));  //output: false

// //----test diff------//
// let obj111 = { name: 'Alice', age: 25, city: 'New York' };
// let obj22 = { name: 'Alice', age: 30, country: 'USA' };
// //console.log(diff(obj111, obj22));  //output: { age: 25, city: 'New York', country: 'USA' }

// //----test forEachObject------//
// let obj33 = { a: 1, b: 2, c: 3 };
// //console.log(forEachObject(obj33, (key, value) => console.log(`${key}: ${value}`)));
// //Expected output:
// // a: 1
// // b: 2
// // c: 3
...
// //console.log(filterObject(obj43, (key, value) => value > 1)); //output: { b: 2, c: 3 }

// //----test fromPairs------//
// let pairs = [['a', 1], ['b', 2], ['c', 3]];
// //console.log(fromPairs(pairs));  //output: { a: 1, b: 2, c: 3 }

// //----test toPairs------//
// let obj53 = { x: 10, y: 20, z: 30 };
// //console.log(toPairs(obj53));  //output: [ ['x', 10], ['y', 20], ['z', 30] ]

// //----test deepFreeze------//
// let obj63 = { name: 'Bob', address: { city: 'Los Angeles' } };
// //console.log(deepFreeze(obj63));
// //console.log(() => { obj6.name = 'Alice'; }); // Should throw error due to immutability

// //----test deepSeal------//
// let obj73 = { name: 'Charlie', age: 25 };
// //console.log(deepSeal(obj73));
...
// //console.log(deepMap(obj83, (key, value) => `${key}-${value}`)); 
...
// let clonedObj = deepCloneWithCircularReferences(obj9);
// //console.log(clonedObj); // Output: Should be a deep clone without circular references

// //----test deepMergeCustomArrays------//
// let obj103 = { numbers: [1, 2, 3], data: { name: 'Alice' } };
// let obj113 = { numbers: [3, 4, 5], data: { age: 30 } };
// //console.log(deepMergeCustomArrays(obj103, obj113));
...
//   try {
//     const destructured = advancedDestructure(obj132, ['a', 'b']);
...
//   const obj21 = {};
//   setObjectValue(obj21, 'a.b.c', 42);
//   console.log(getObjectValue(obj21, 'a.b.c')); // Expected output: 42
//   console.log(getObjectValue(obj21, 'a.b.d')); // Expected output: undefined (non-existing path)
  
//   // ----- Test deepEqualWithTolerance -----
//   const obj3 = { x: 1.0001, y: 2 };
//   const obj4 = { x: 1.0002, y: 2 };
//   console.log(deepEqualWithTolerance(obj3, obj4, 0.001)); // Expected output: true (within tolerance)
//   console.log(deepEqualWithTolerance(obj3, obj4, 0.00001)); // Expected output: false (out of tolerance)
  
//   // ----- Test createObjectWatcher -----
//   const obj5 = { a: 1, b: 2 };
//   const watcher = createObjectWatcher(obj5, (key, value) => {
...
//   const wrathObject = generateWrathObject(2, 3); // Depth 2 and max 3 keys per level
//   console.log(wrathObject); // Random object with depth and random keys
  
//   // ----- Test reverseObject -----
//   const obj12 = { a: { b: 1 }, c: 2 };
//   const reversedObj = reverseObject(obj12);
...
//   ];
//   const reincarnated = reincarnateObject(obj13, transformations);
//   console.log(reincarnated); // Expected output: { a: 1, b: 3, c: 4 }
  
//   // ----- Test unholyMerge -----
//   const obj14 = { a: { x: 1 }, b: 2 };
//   const obj15 = { a: { y: 3 }, c: 4 };
//   const merged = unholyMerge(obj14, obj15);
